...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelectImage = findViewById(R.id.AddGaleryImageID);
        imageCategory = findViewById(R.id.image_categoryId);
        UploadImage = findViewById(R.id.uploadImageButtonId);
        GalleryImageView = findViewById(R.id.galleryImageViewsId);
        ...
        UploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bitmap == null){
                    ...
                    Toast.makeText(UploadImage.this, "Please Selet your Category", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void uploadData() {
        ...
        reference.child(uniqueKey).setValue(downloadurl).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                pd.dismiss();
                Toast.makeText(UploadImage.this, "Image Upload Successfull.", Toast.LENGTH_SHORT).show();
            }
